...
module.exports = {
  ...
  discord: {
    token: process.env.DISCORD_TOKEN || 'seu-token-aqui',
    clientId: process.env.DISCORD_CLIENT_ID || 'seu-client-id-aqui',
  ...
  database: {
    uri: process.env.DB_URI || 'mongodb://localhost:27017/mercadao',
    options: {
  ...
  payment: {
    pix: {
      ...
      keyValue: process.env.PIX_KEY || 'chave-pix-aqui',
